...
export class DocumentService {
  public getDocuments(criteria: any) {
    return this.http.post<any>(environment.baseUrl + '/Library/DataPoint/GetDataPoints', { params: criteria })
  }
  ...
  public getDocumentsCount(criteria: any) {
    return this.http.post<any>(environment.baseUrl + '/Library/DataPoint/GetDataPointsCount', { params: criteria })
  }
